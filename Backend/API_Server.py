...
def chat_handler():
    try:
        ...
        agent_tools = [
            find_top_filtered_stocks, find_stocks_by_price_change,
            get_complete_stock_details, get_recent_news,
            get_financial_highlights, get_company_profile,
        ]
